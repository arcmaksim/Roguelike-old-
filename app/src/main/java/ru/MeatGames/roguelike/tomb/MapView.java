...
public class MapView extends View{
	/**
	 * @uml.property  name="time2"
	 */
	public long time2;
	/**
	 * @uml.property  name="animTime"
	 */
	public long animTime;
    /**
	 * @uml.property  name="camx"
	 */
    public int camx;
    /**
	 * @uml.property  name="camy"
	 */
    public int camy;
    /**
    ...
    /**
	 * @uml.property  name="prgb"
	 */
    public boolean prgb=false;
    /**
	 * @uml.property  name="death"
	 */
	...
	protected void drawExit(Canvas canvas){
		...
		text.setTextAlign(Paint.Align.CENTER);
		text.setTextSize(24);
		canvas.drawText("����� �� ����?",240,370,text);
		text.setTextSize(16);
		canvas.drawText("��",140,444,text);
		canvas.drawText("���",340,444,text);
	}
	...
	protected void drawLog(Canvas canvas){
		...
		for(int c=0;c<maxLines;c++)
			canvas.drawText(log[c].t,5,20+21*c,text);
	}
    ...
    protected void drawProgBar(Canvas canvas){
		...
		text.setTextAlign(Paint.Align.CENTER);
		canvas.drawText("������",240,Global.hero.y-16,text);
	}
    ...
    protected void drawFinal(Canvas canvas){
        ...
        text.setTextSize(24);
        if(death){
            canvas.drawText("����� ��",240,320,text);
            canvas.drawBitmap(Global.game.lastAttack,204,340,null);
        }
        if(win){
            canvas.drawText("������!",240,320,text);
            canvas.drawText("������ ����!",240,360,text);
        }
        text.setTextSize(16);
        canvas.drawText("� ����",240,765,text);
    }
	...
	private int sign (int x) {return (x > 0)?1:(x < 0)?-1:0;}
    ...
    public void onTouchMain(){
        ...
        if(y1>48 && y1<720)
            switch(((y1-48)/224)*3 + x1/160){
                case 0: Global.game.move(-1,-1); break;
                case 1: Global.game.move(0,-1); break;
                case 2: Global.game.move(1,-1); break;
                case 3: Global.game.move(-1,0); break;
                case 4:
                    ...
                    if(Global.map[Global.hero.mx][Global.hero.my].hasItem()){
                        ...
                        addLine(item.n+" ��������"+item.n1);
                        Global.game.v.vibrate(30);
                        Global.game.move(0,0);
                    }
                    break;
                case 5: Global.game.move(1,0); break;
                case 6: Global.game.move(-1,1); break;
                case 7: Global.game.move(0,1); break;
                case 8: Global.game.move(1,1); break;
            }
        if(y1>720){
            if(x1<120)
